...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on Tulio.
...
This date is not used by Tulio, but can be used as a reminder.
