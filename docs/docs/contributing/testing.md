...
```bash
# Debian
wget https://beta-apt.tuliocp.com/tulio-install-debian.sh
# or Ubuntu
wget https://beta-apt.tuliocp.com/tulio-install-ubuntu.sh
```

Then install via bash tulio-install-debian.sh or bash tulio-install-ubuntu.sh
...
If you encounter a bug, please [open an issue](https://github.com/marcosfermin/tuliocp/issues/new/choose) or [submit a Pull Request](https://github.com/marcosfermin/tuliocp/pulls). You can also report it on our forum or our Discord server
