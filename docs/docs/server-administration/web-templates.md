...
As we have over 20 different templates and we don’t use them all, we have decided to stop releasing new ones the future and hope the community helps improving the templates by [submitting a Pull Request](https://github.com/marcosfermin/tuliocp/pulls).
...
### Does Tulio support WebSockets?

Yes, Tulio works fine with WebSockets; however, our default templates include by default:
