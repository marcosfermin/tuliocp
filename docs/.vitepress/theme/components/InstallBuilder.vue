		...
		<div class="container">
			<div class="output-card">
				...
				<CopyToClipboardInput
					class="u-mb10"
					value="wget https://raw.githubusercontent.com/marcosfermin/tuliocp/release/install/tulio-install.sh"
				/>
				<p class="u-mb10">
...
const installCommand = ref("bash tulio-install.sh");
watchEffect(() => {
	let cmd = "bash tulio-install.sh";
