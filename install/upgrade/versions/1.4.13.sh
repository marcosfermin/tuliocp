...
# Tulio Control Panel upgrade script for target version 1.4.13
...
if [ "$PHPMYADMIN_KEY" != "" ]; then
	echo "[ * ] Updating tulio-sso for phpMyAdmin..."
...
# Remove old files/folders from previous versions of Tulio Control Panel
