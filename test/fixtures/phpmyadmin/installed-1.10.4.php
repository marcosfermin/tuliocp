...
define("PHPMYADMIN_KEY", "legacyPmaKey123");
define("API_HOST_NAME", "panel.tuliocp.com");
define("API_TULIO_PORT", "8083");
define("API_KEY", "legacyApiKey456");
...
class Tulio_API {
	...
	public function __construct() {
		$this->hostname = "https://" . API_HOST_NAME . ":" . API_TULIO_PORT . "/api/";
		$this->key = API_KEY;
