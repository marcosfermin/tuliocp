...
> **Note:** TulioCP is derived from HestiaCP (GPL-3.0), itself derived from
> VestaCP. Everything below this line is the upstream HestiaCP release history,
> preserved verbatim. It intentionally still says "Hestia" and still links to
> `github.com/hestiacp/hestiacp` pull requests and issues, because those are the
